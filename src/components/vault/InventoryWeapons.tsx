...
export function InventoryWeapons({ ids, counts, onSellItem, dwellers, rooms, onEquipWeapon }: InventoryWeaponsProps) {
  ...
  return (
    <div className="flex flex-col">
      <div className="hidden sm:grid grid-cols-[80px_3fr_1.5fr_1fr_200px] gap-4 px-4 py-3 -mt-3 mb-3 border-b border-border/40 sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
